...
urlpatterns = [
    ...
    path('mycompany/vacancy-list', views.MyVacancyListView.as_view(), name='my_vacancies'),
    path('mycompany/vacancy-edit/<int:pk>/', views.VacancyEditView.as_view(), name='vacancy-edit'),
