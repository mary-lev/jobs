...
class Vacancy(models.Model):
    ...
    skills = models.CharField(max_length=1000, blank=True, null=True, verbose_name='Требуемые навыки')
    description = models.CharField(max_length=10000, blank=True, null=True, verbose_name='Описание вакансии')
...
class Resume(models.Model):
    ...
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, verbose_name='Готовность к работе')
